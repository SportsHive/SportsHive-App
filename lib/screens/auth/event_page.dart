                    ...
                    Row(
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          child: ClipRRect(
                              borderRadius: BorderRadius.circular(30),
                              child: Image.asset("assets/images/profilepicsample.png", height: 60,)),
                        )
                      ],
                    ),
                    SizedBox(height: 20,),
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Row(
                    children: <Widget>[
                      Image.asset("assets/images/clock_icon.png", height: 12,),
                      SizedBox(width: 8,),
                      Text(date, style: TextStyle(
                          color: Colors.white,
                          fontSize: 10
                  ...
                  Row(
                    children: <Widget>[
                      Image.asset("assets/images/location_icon.png", height: 12,),
                      SizedBox(width: 8,),
